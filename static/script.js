availableImages=['Images/img-1.png','Images/img-2.png','Images/img-3.png','Images/img-4.png','Images/img-5.png','Images/img-6.png','Images/img-7.png','Images/img-8.png','Images/img-1.png','Images/img-2.png','Images/img-3.png','Images/img-4.png','Images/img-5.png','Images/img-6.png','Images/img-7.png','Images/img-8.png']
        ...
        div.addEventListener('click',function(event){
           ...
           var currentlyshowing = document.getElementsByClassName('showimg');
            ...
            if(document.getElementsByClassName('match').length==16){
                ...
                let node= document.createTextNode("Your Total Score: "+moves);
